        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="mt-6">
                    ...
                    <div class="bg-gray-200 border-2 border-dashed rounded-xl w-full h-64 flex items-center justify-center">
                        <div class="text-center">
                            ...
                            <p class="text-gray-600">Mapa de Google Maps</p>
                            <p class="text-sm text-gray-500">Integrar con Google Maps API</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-8 bg-blue-50 border-l-4 border-blue-600 p-6 rounded">
                    ...
                    <a href="/agendar-cita.php" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition duration-300">
                        Agendar Cita Ahora
                    </a>
                </div>
            </div>
